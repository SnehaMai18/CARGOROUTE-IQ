...
public class ProofOfDelivery {
   ...
   private Long driverId; // Driver ID who submitted this POD
   ...
   public ProofOfDelivery(Long podID, Long bookingID, Long driverId, LocalDateTime deliveredAt, String receivedBy, String podURI,
