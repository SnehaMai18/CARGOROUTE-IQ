...
class DriverControllerTest {
    ...
    void createDriver_ShouldReturn201_WhenCreated() throws Exception {
        // Change: Added mocking for service call verification
        when(driverService.insert(any(DriverDTO.class))).thenReturn(driverDTO);
        ...
        verify(driverService).insert(any(DriverDTO.class));
    }

    @Test
    void getDriverById_ShouldReturn200_WhenFound() throws Exception {
        when(driverService.fetchByID(1L)).thenReturn(driverDTO);
    ...
    void getAllDrivers_ShouldReturn200_WithList() throws Exception {
        when(driverService.fetchAll()).thenReturn(List.of(driverDTO));
    ...
    void updateDriver_ShouldReturn200_WhenUpdated() throws Exception {
        ...
        verify(driverService).updateDriver(eq(1L), any(DriverDTO.class));
    }
